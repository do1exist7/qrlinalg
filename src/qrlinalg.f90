...
contains
  ...
  !H and S are required to be square and of equal order. Only their lower
  !triangles, including the diagonal, are referenced. The opposite triangle
  !of M is generated by symmetry, so the upper triangles of H and S need not
  !be initialized.
  !
  !  Input parameters:
  !    h     - An n by n real array whose lower triangle contains the
  !            symmetric Hamiltonian matrix H. The upper triangle is ignored.
  !    s     - An n by n real array whose lower triangle contains the
  !            symmetric overlap matrix S. The upper triangle is ignored.
  ...
  !retain H and S.
  !
  !Only the lower triangles of H and S, including their diagonals, are read.
  !The upper triangle of the shifted matrix is generated by conjugating its
  !lower triangle. Each physical diagonal must be real within
  !
  ...
  !
  !  Input parameters:
  !    h     - An n by n complex array whose lower triangle contains the
  !            Hermitian Hamiltonian matrix H. The upper triangle is ignored.
  !    s     - An n by n complex array whose lower triangle contains the
  !            Hermitian overlap matrix S. The upper triangle is ignored.
  !    shift - The real shift represented by the factorization.
  !
  !  Input/output parameter:
